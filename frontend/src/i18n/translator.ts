...
const translations: TranslationMap = {
  ...
  'backlog.deleteSprint': {
    en: 'Delete sprint', hi: 'स्प्रिंट हटाएं', te: 'స్ప్రింట్ తొలగించు', ta: 'ஸ்பிரிண்டை நீக்கு', kn: 'ಸ್ಪ್ರಿಂಟ್ ಅಳಿಸಿ',
  },
  'backlog.confirmDeleteSprint': {
    en: 'Delete this sprint? Tasks in it will return to the backlog.', hi: 'यह स्प्रिंट हटाएं? इसके कार्य बैकलॉग में चले जाएंगे।', te: 'ఈ స్ప్రింట్ తొలగించాలా? దాని టాస్క్‌లు బ్యాక్‌లాగ్‌కు వెళ్తాయి.', ta: 'இந்த ஸ்பிரிண்டை நீக்கவா? அதிலுள்ள பணிகள் பேக்லாக்குக்குச் செல்லும்.', kn: 'ಈ ಸ್ಪ್ರಿಂಟ್ ಅಳಿಸುವುದೇ? ಅದರಲ್ಲಿನ ಕಾರ್ಯಗಳು ಬ್ಯಾಕ್‌ಲಾಗ್‌ಗೆ ಹೋಗುತ್ತವೆ.',
  },
  'backlog.create': {
    en: '+ Create', hi: '+ बनाएं', te: '+ సృష్టించు', ta: '+ உருவாக்கு', kn: '+ ರಚಿಸಿ',
  },
